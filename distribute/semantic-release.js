...
if (!packageName) {
    throw new error_1.default('The package name must be provided.', 'ENOPACKAGENAME', 'Make sure to add the environment variable \'COLONISE_PACKAGE_NAME\' to the Travis CI build.');
}
